  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[15%] right-[10%] text-gray-800 text-5xl font-black italic tracking-tighter opacity-30 text-right">
          "YOUR BLOOD <br/> IS A GIFT"
        </div>
        <div className="absolute bottom-[15%] left-[10%] text-red-700 text-5xl font-black italic tracking-tighter opacity-40 text-left">
      ...
      <div className="w-full max-w-2xl bg-white p-12 rounded-[3rem] shadow-2xl border border-gray-100 z-10">
        <div className="text-center mb-10">
          <h2 className="text-4xl font-extrabold text-gray-900 mb-3">Hi, New Donor! 👋</h2>
          <p className="text-gray-500 text-lg">Every drop counts. Complete your profile to start saving lives.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <select name="bloodType" onChange={handleChange} required className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-gray-100 focus:border-red-600 outline-none transition">
            ...
            <div className="space-y-2">
              ...
              <input type="number" name="age" onChange={handleChange} required className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-gray-100 focus:border-red-600 outline-none transition" />
            </div>
            <div className="space-y-2">
              <label className="block text-sm font-bold text-gray-700">Days Since Last Donation</label>
              <input type="number" name="lastDonationDays" onChange={handleChange} required className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-gray-100 focus:border-red-600 outline-none transition" />
            </div>
            <div className="space-y-2">
              <label className="block text-sm font-bold text-gray-700">Distance from Hospital (KM)</label>
              <input type="number" step="0.1" name="distanceKM" onChange={handleChange} required className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-gray-100 focus:border-red-600 outline-none transition" />
            </div>
          </div>

          <button type="submit" disabled={loading} className="w-full bg-red-600 hover:bg-black text-white font-black py-5 rounded-2xl text-lg transition-all transform hover:scale-[1.01] active:scale-[0.99]">
